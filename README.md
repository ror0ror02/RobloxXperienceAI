...
### Сотрудничество с другими игроками в игре "Guerra de Torres" ***(СКОРО!)***

- **Описание:** RobloxXperienceAI Должен Сражаться вместе с командой.
- **Цель:** Исследовать, как RobloxXperienceAI может Сражаться.
- **Шаги:** Запустить RobloxXperienceAI в игре Guerra de Torres и наблюдать за его взаимодействием.
...
- Эксперимент в игре ***"Jailbreak"*** ***"Имитация новичка"*** Нейросеть Училась летать На вертолёте. Также Ей Помогал Один Заключённый, Хотя Она сама Полицейская. Также в Финальном Исследовании Устроила Перестрелку с Полицейским, Хотя Она Тоже Полицейска.
- Скоро 
...
### Проект использует 12 нейронных сетей для действий в игре. Есть нейронные сети для каждого из следующих действий:
...
(Будут выходить новые версии, И будет больше Действий)
...
**Примечание**: Если у вас возникают *проблемы с установкой,* **убедитесь, что у вас установлены Git и Python.** В противном случае, установите их перед выполнением скрипта установки Или *Создайте Раздел Проблеммы.*
